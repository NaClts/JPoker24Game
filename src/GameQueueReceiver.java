...
public class GameQueueReceiver {

	private String host;
	public GameQueueReceiver(String host) throws NamingException, JMSException {
		this.host = host;
	...
	public String receiveMessage(long timeout) throws JMSException {
        ...
        Message m;
        if (timeout != -1) {
            m = queueReceiver.receive(timeout);
        } else {
        ...
        if(m != null && m instanceof TextMessage) {
            ...
            stringifiedMessage = textMessage.getText();
			System.out.println("Received message: "+stringifiedMessage);
        } else {
            stringifiedMessage = null;
        }
